...
<link rel="stylesheet"
    ...
    <link rel="sortcut icon" href="https://www.google.com/imgres?imgurl=https%3A%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fcommons%2Fthumb%2Fb%2Fbe%2FFlag_of_Goi%25C3%25A1s.svg%2F1200px-Flag_of_Goi%25C3%25A1s.svg.png&imgrefurl=https%3A%2F%2Fpt.wikipedia.org%2Fwiki%2FBandeira_de_Goi%25C3%25A1s&tbnid=CDDt_QSGA9bjnM&vet=12ahUKEwiyh5H2ouvxAhVXKrkGHYXxD7MQMygAegUIARC3AQ..i&docid=hjpMhHl_z-h9KM&w=1200&h=840&q=bandeira%20do%20goi%C3%A1s&ved=2ahUKEwiyh5H2ouvxAhVXKrkGHYXxD7MQMygAegUIARC3AQ" type="image/gif" />
</head>
<style>
*{
    margin:0;
		...
		<div class="card ass">
			...
			<div class="cadastro">
				...
				<br>
				 ...
				 <a href="relatorio" style="text-align:center">Gerar Relatório</a>
			</div>
		</form>
		</div>
		      <div id="footer">
